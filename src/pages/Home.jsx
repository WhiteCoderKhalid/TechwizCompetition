...
const Home = () => {
  ...
  const upcomingEvents = useMemo(() => {
    return eventsData
      .map((ev) => ({
        ...ev,
        timestamp: parseTimeToTimestamp(ev.date, ev.time),
      }))
  ...
  const handleLearnMore = (event) =>
    setSelectedEvent({
      ...event,
      timestamp: parseTimeToTimestamp(event.date, event.time),
    });
    ...
    <div className="min-h-screen">
      <section className="relative h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl">
                  ...
                  <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-8 sm:mb-10">
                    {banner.subtitle}
                  </p>
                  <Link
                    to={banner.ctaLink}
                    className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105"
                  >
        ...
        <button
          ...
          className="absolute left-4 top-[61%] sm:top-1/2 -translate-y-1/2 bg-white/20 backdrop-blur-md text-white p-3 rounded-full hover:bg-white/30 transition"
        >
        ...
        <button
          ...
          className="absolute right-4 top-[61%] sm:top-1/2 -translate-y-1/2 bg-white/20 backdrop-blur-md text-white p-3 rounded-full hover:bg-white/30 transition"
        >
